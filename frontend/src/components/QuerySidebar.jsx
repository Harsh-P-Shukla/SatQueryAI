      ...
      {isOpen && (
        <>
          <motion.div
            ...
            className={`fixed right-0 top-0 z-50 flex h-full w-full max-w-[420px] flex-col overflow-hidden shadow-2xl ${
              isDark
          ...
          >
            ...
            <div
              className={`relative flex items-center justify-between overflow-hidden border-b p-5 ${
                isDark
            ...
            >
              <div className="relative z-10">
                ...
                >
                  Ask, ground, and export findings
                </p>
              </div>
            ...
            <div className="h-full flex-1 space-y-6 overflow-y-auto p-5">
                  ...
                  >
                    ...
                    >
                      <Button
                        ...
                        className={`rounded-lg px-5 shadow-lg transition-all duration-300 disabled:opacity-50 ${
                          isDark
